...
export default function DriverRegisterPage() {
  ...
  const validateStep = (step: Step): boolean => {
    switch (step) {
      ...
      case 2:
        ...
        return true;
      case 3:
        if (!formData.bsb.trim() || formData.bsb.length !== 6) {
          setError("Please enter a valid 6-digit BSB");
          return false;
        }
  ...
  const goToStep = (step: Step) => {
    ...
    if (step > currentStep) {
      // Validate all steps up to current before allowing jump forward
  ...
  const isStepComplete = (step: Step): boolean => {
    switch (step) {
      ...
      case 2:
        return !!(formData.licenseNumber && formData.licenseExpiry);
      case 3:
        return !!(formData.bsb && formData.accountNumber && formData.accountName);
      default:
        return false;
    }
  };
        ...
        <div className="mx-auto max-w-2xl">
                    ...
                    {index > 0 && (
                      <div
                        className={`flex-1 h-1 ${
                          currentStep > step.number - 1 ? "bg-emerald-500" : "bg-slate-200"
                        }`}
                      />
                    )}
                    <button
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-12 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                        >
                    ...
                    <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl">
                      <p className="text-sm text-amber-800">
                        <strong>Note:</strong> You must have a valid Australian driver&apos;s license with no major infringements in the last 3 years.
                      </p>
                    </div>
                  </div>
                </motion.div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={formData.bsb}
                          onChange={(e) => updateField("bsb", e.target.value.replace(/\D/g, "").slice(0, 6))}
                          className="w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                          placeholder="000-000"
                          maxLength={6}
                        />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-slate-300 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition"
                        placeholder="11 digit ABN (if you have one)"
                        maxLength={11}
                      />
                      <p className="mt-1.5 text-xs text-slate-500">
                        Don&apos;t have an ABN? You can add it later.
                      </p>
                    </div>
                  </div>
                </motion.div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div className="text-slate-900 font-medium">{formData.firstName} {formData.lastName}</div>
                    ...
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div className="text-slate-900 font-medium">{formData.licenseNumber}</div>
                        <div className="text-slate-500">State:</div>
                        <div className="text-slate-900 font-medium">{formData.licenseState}</div>
                        <div className="text-slate-500">Expiry:</div>
                        <div className="text-slate-900 font-medium">{formData.licenseExpiry}</div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div className="text-slate-500">BSB:</div>
                        <div className="text-slate-900 font-medium">{formData.bsb}</div>
                        <div className="text-slate-500">Account:</div>
                        <div className="text-slate-900 font-medium">••••{formData.accountNumber.slice(-4)}</div>
                        <div className="text-slate-500">Name:</div>
                        <div className="text-slate-900 font-medium">{formData.accountName}</div>
                        {formData.abn && (
                          <>
                    ...
                    <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                      <p className="text-sm text-emerald-800">
                        By submitting, you agree to our Terms of Service and Privacy Policy. Your application will be reviewed within 1-2 business days.
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-200">
                {currentStep > 1 ? (
                  <button
                    type="button"
                    onClick={prevStep}
                    className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-slate-600 hover:text-slate-900 transition"
                  >
                ...
                {currentStep < 4 ? (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl shadow-sm transition"
                  >
                    Continue
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl shadow-sm transition disabled:opacity-50"
                  >
                    {loading ? (
                      <>
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-slate-600 text-sm">
              ...
              <Link href="/driver/login" className="font-semibold text-emerald-600 hover:text-emerald-700 transition">
                Sign in
              </Link>
            </p>
            <Link
