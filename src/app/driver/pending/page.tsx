...
export default function DriverPendingPage() {
  ...
  useEffect(() => {
    if (status === "authenticated") {
      ...
      // If user is not a driver role, redirect to appropriate page
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-lg">
        <div className="bg-white py-8 px-6 shadow-xl shadow-slate-200/50 rounded-3xl border border-slate-200">
          ...
          <p className="mt-4 text-center text-slate-600">
            Thank you for applying to become a Drivlet driver! Our team is currently
          ...
          <div className="mt-8 p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
            ...
            <ul className="mt-3 space-y-2 text-sm text-emerald-700">
              <li className="flex items-start gap-2">
                ...
                <span>We verify your license and identity (1-2 business days)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full bg-emerald-200 text-emerald-800 text-xs font-bold">
                  2
                </span>
                <span>Background check processing (if required)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded-full bg-emerald-200 text-emerald-800 text-xs font-bold">
                  3
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Start accepting jobs and earning!</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            <div className="p-3 bg-slate-50 rounded-xl text-center">
              <FileCheck className="h-6 w-6 text-slate-600 mx-auto" />
              <p className="mt-1 text-xs text-slate-600">License</p>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl text-center">
              <Shield className="h-6 w-6 text-slate-600 mx-auto" />
              <p className="mt-1 text-xs text-slate-600">Background</p>
            </div>
            <div className="p-3 bg-slate-50 rounded-xl text-center">
              <CreditCard className="h-6 w-6 text-slate-600 mx-auto" />
              <p className="mt-1 text-xs text-slate-600">Banking</p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-slate-50 rounded-xl">
            ...
            <div className="space-y-2">
              <a
                href="mailto:drivers@drivlet.com"
