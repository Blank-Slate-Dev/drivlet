...
export default function DriverPendingPage() {
  ...
  const steps = [
    { num: 1, text: "We verify your license and identity", time: "1-2 business days", done: true },
    { num: 2, text: "Background check processing", time: "If required", done: false },
    { num: 3, text: "You'll receive an email once approved", time: "", done: false },
    { num: 4, text: "Start accepting jobs and earning!", time: "", done: false },
  ];
          ...
          <div className="rounded-3xl border border-white/20 bg-white/95 backdrop-blur-sm shadow-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-8 text-center relative overflow-hidden">
              ...
              <p className="text-amber-100 mt-1">
                We&apos;re reviewing your driver application
              </p>
            </div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="grid grid-cols-3 gap-3 mb-8">
                {[
                  { icon: FileCheck, label: "License", color: "emerald" },
                  { icon: Shield, label: "Background", color: "blue" },
                  { icon: CreditCard, label: "Banking", color: "purple" },
                ].map((item, index) => (
                  <motion.div
                    key={item.label}
