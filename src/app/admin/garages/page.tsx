...
export default function AdminGaragesPage() {
  // PHASE 1 GUARD (2026-08-08): all hooks live in the Inner component, so
  // this branch is rules-of-hooks safe.
  if (!FEATURES.GARAGE_PORTAL) {
    return <GaragePortalPhase2Notice title="Garages" />;
  }
  return <AdminGaragesPageInner />;
}

function GaragePortalPhase2Notice({ title }: { title: string }) {
  return (
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Phase 1 runs transport only, with no garage involvement. This page
            returns when NEXT_PUBLIC_ENABLE_GARAGE_PORTAL is switched on.
          </p>
        </div>
      </div>
    </div>
...
function AdminGaragesPageInner() {
