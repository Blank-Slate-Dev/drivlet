...
export const LOCATIONS: Record<string, CityData> = {
  ...
  canberra: {
    ...
    suburbs: [
      ...
      { slug: 'braddon', name: 'Braddon', postcode: '2612', description: 'Working in Braddon? Drivlet picks up your car, takes it to the service centre, and returns it, with no disruption to your day.' },
...
export const GLOBAL_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes. More than 24 hours before pick-up = full refund. Less than 24 hours = 50% refund. After pickup time = no refund. Full rules are in our Cancellation & Refunds Policy.',
  },
];
